...
import {faArrowUpWideShort,faFilter,faSignature,faSquareParking,faEllipsisVertical,faGears,faRightFromBracket,faBriefcase,faCalendarCheck,faChartColumn,faShareFromSquare,faBuildingColumns,faPiggyBank,faUserGear,faFileLines,faScaleBalanced, faCreditCard,faCircleUser,faGaugeHigh, faUserMinus, faMoneyBill1, faUserPlus,faUser, faBars, faBell, faMoneyBills,faUsers ,faSortDown, faCommentDots, faNairaSign, faUserCheck} from '@fortawesome/free-solid-svg-icons'
    ...
    <div className='MainContainer'>
        ...
        <div className='Header_row'>
            ...
            <div className='HeaderContainer5'>
                ...
                <div className='HeaderContainer6'>
                <div className='HeaderContainer7'>
                        ...
                        <div className='HeaderContainerText'>
                            <h1 className='TextHead'>200</h1>
                            <p className='TextPara'>ACTIVE USERS</p>
                        </div>
                    </div>
                    <div className='HeaderContainer7'>
                        <div className='HeaderContainerIcon'>
                    ...
                    <div className='HeaderContainer7'>
                        <div className='HeaderContainerIcon'>
                            <FontAwesomeIcon icon={faBuildingColumns} style={{color: '#fff'}}/>
                        </div>
                        <div className='HeaderContainerText'>
                            <h1 className='TextHead'>10</h1>
                            <p className='TextPara'>OTHER ACCOUNTS</p>
                        </div>
                    </div>
                    <div className='HeaderContainer7'>
                        <div className='HeaderContainerIcon'>
                ...
                <div className='LoanListContainer1'>
                                                <div className='LoanListContainer2'>
                                                    <h1 className='AppliedText'>Recent Loans</h1>
